...
# Wczytanie danych z pliku sonar.all-data
data = pd.read_csv('sonar.all-data', header=None)

# Przekonwertowanie etykiet do postaci numerycznej
le = LabelEncoder()
x = data.iloc[:, :-1]  # Wybierz wszystkie kolumny z wyjątkiem ostatniej
y_t = data.iloc[:, -1]   # Wybierz ostatnią kolumnę jako etykiety
